...
const RequestsManagement = () => {
  ...
  const fetchRequests = useCallback(async () => {
    ...
    try {
      ...
      toast.error(error?.message || error?.msg || "Failed to fetch requests");
      setList({ results: [], total: 0 });
    } finally {
      setLoading(false);
    }
  ...
  const tabs = [
    { id: "all", label: t("RequestManagementData.all") },
    { id: "open", label: t("RequestManagementData.open") },
    { id: "accepted", label: t("RequestManagementData.accepted") },
    { id: "pending", label: t("RequestManagementData.pending") },
    { id: "completed", label: t("RequestManagementData.completed") },
    { id: "cancelled", label: t("RequestManagementData.cancelled") },
    { id: "expired", label: t("RequestManagementData.expired") },
  ];
  ...
  return (
    <MainLayout title={t("RequestManagementData.requestManagement")}>
      <div className="mt-5 relative">
        ...
        <Input
          size="lg"
          placeholder={t("RequestManagementData.searchRequests")}
